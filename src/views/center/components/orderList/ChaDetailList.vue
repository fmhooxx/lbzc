                    ...
                    <div class="item">
                        <div class="top">
                            <div class="left">
                                ...
                                <div class="name">{{item.title|threePoints(9)}}</div>
                            </div>
                        ...
                        <div class="center">
                            <div class="userName">
                                ...
                                <div class="bottom">{{item.TrueName}}</div>
                            </div>
                            <div class="mobileNum">
                            ...
                            <div class="reason">
                                ...
                                >{{state|stateVal(item.OrderAmount,type)}}</div>
                            </div>
                        </div>
                        <div class="bottom">
                            <div class="left">
...
<script>
import { getChaList } from '_api/center';
export default {
    props: {
        type: {
            type: String,
